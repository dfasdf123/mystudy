...
public class Ex30RecyclerAdapter extends RecyclerView.Adapter<Ex30RecyclerAdapter.ViewHolder> {

    public ArrayList<Ex30ItemData> itemData;
    public Ex30RecyclerAdapter(ArrayList<Ex30ItemData> itemData) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.activity_ex30_php_item, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        Ex30ItemData item = itemData.get(position);
